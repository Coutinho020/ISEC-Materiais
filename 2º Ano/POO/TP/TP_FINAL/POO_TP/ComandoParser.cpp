...
Comando ComandoParser::parse(const string &linha, const Jardim *jardim, bool estaInicializado) const {
    ...
    if (prefixo == "planta") {
        ...
        if (cmd.numTokens != 3 || !validaCoordenada(cmd.tokens[1]) || !validaPlanta(cmd.tokens[2])) {
            cmd.tipo = ComandoTipo::CMD_INVALID;
            cmd.erro = "Sintaxe: planta lc <tipo de planta>  ||  Tipo de plantas: c | r | e | x";
            return cmd;
        }
        return cmd;
    }
    ...
    if (prefixo == "compra") {
        ...
        if (cmd.numTokens != 2 || !validaFerramenta(cmd.tokens[1])) {
            cmd.tipo = ComandoTipo::CMD_INVALID;
            cmd.erro = "Sintaxe: compra <tipo de ferramenta> ||  Tipo de Ferramentas: g | a | t | z";
            return cmd;
        }
        return cmd;
    }
    ...
    if (prefixo == "grava") {
        ...
        if (cmd.numTokens != 2) {
            cmd.tipo = ComandoTipo::CMD_INVALID;
            cmd.erro = "Sintaxe: grava nomeCopia";
            return cmd;
        }
        return cmd;
    }
    ...
    if (prefixo == "recupera") {
        ...
        if (cmd.numTokens != 2) {
            cmd.tipo = ComandoTipo::CMD_INVALID;
            cmd.erro = "Sintaxe: recupera nomeCopia";
            return cmd;
        }
        return cmd;
    }
    ...
    if (prefixo == "apaga") {
        ...
        if (cmd.numTokens != 2) {
            cmd.tipo = ComandoTipo::CMD_INVALID;
            cmd.erro = "Sintaxe: apaga nomeCopia";
            return cmd;
        }
        return cmd;
    }
